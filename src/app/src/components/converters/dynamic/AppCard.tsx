...
const AppCard = ({
  ...
  return (
    <div
      className="bg-white p-4 w-80 h-24 rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl cursor-pointer relative"
    ...
    >
      <div className="flex flex-col items-center">
        ...
        <p className="text-gray-500 text-sm text-center line-clamp-2 overflow-hidden transition-all duration-300">
          {description}
        </p>
